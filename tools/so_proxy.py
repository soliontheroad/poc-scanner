...
class KunpengSo(object) :
    ...
    def __init__(self,sopath):
        ...
        self.kunpeng.BufferContent.argtype = [c_char_p]
        self.kunpeng.BufferContent.restype = c_char_p
    ...
    def BufferContent(self,sep=""):
        return self.kunpeng.BufferContent(_args_encode(sep))
